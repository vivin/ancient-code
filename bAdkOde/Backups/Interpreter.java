...
class Interpreter
{
       ...
       public boolean Interpret(StringTokenizer tokens) throws MyException
       {
              String KeyWord = "";
              int error = 0;
              boolean fatal = false;
                    ...
                    else
                    {
                       ...
                       else
                       {
                          ...
                          {                                   
                             ...
                             {
                                   System.out.println("A " + Fatal + " exception was encountered on line " + line + " while trying to initialize variable.");
                                   fatal = true;
                             }
                          }
