...
public class bAdkOde
{
       ...
       {
              StringTokenizer tokens = new StringTokenizer("", " \r\\>;\"#", true);
	      ...
	      boolean fatal_error = false;
              ...
              {
                 System.out.println("bAdkOde (c) Interpreter Beta v1.0 by Vivin Suresh Paliath\n");
                 System.out.println("Copyright (c) 2001 -->");
                 System.out.println("This product is FreeWare\n");
		 ...
		 if(!fatal_error)
		 {
              ...
              while(InputString != null && !fatal && !fatal_error)
              {
                    ...
                    if(!fatal)
                    {
                       ...
                       {
                          tokens = new StringTokenizer(InputString, " \r\\><\"#;", true);
                       }
                    }                    
              }
