...
class symbolTable
{
      ...
      //Hmm... Arrays are by default dynamic. Meaning, if you had an array if 4 locations initially, and you try to 
      //assign a value to the 5th location, the array will automatically grow.
                                        ...
                                        else
                                        {
                                           ...
                                           else
                                           {
                                              ...
                                              if(RValType.compareTo("valuelist") == 0)
                                              {
                                                 ...
                                                 //updated comment:
                                                 //No warning will be issued for truncated arrays.
                                                 //This information however, will be provided in the specs.
                                                 ...
                                                 if(!error)
                                                 {
                                                    ...
                                                    if(type.compareTo("dynamic") == 0 || new Integer(ArraySize).intValue() == 0)
                                                    {
                                                       ArraySize = new Integer(countValues(RValue)).toString();
                                                    }

                                                    ArrayVals = parseList(RValue, ArraySize);
                                              ...
                                              {
                                                 if(RValType.compareTo("Identifier") == 0)
                                                 {
                                                    if(doesArrayExist(RValue))
                                                    {
                                                       try
                                                       {
                                                         ArrayVals = copyArray(ArraySize, RValue);
                                                       }

                                                       catch(IllegalArgumentException CopyError)
                                                       {
						             errcode = 5;
						             error = true;
                                                    ...
                                                    else
                                                    {
                                                       errcode = 5;
                                                       error = true;
                                                       System.out.println("\nCannot assign variable to Array");
                                                    }
                                                 }

                                                 else
                                                 {
                                                    if(RValType.compareTo("expression") == 0)
                                                    {
                                                       errcode = 5;
                                                       error = true;
                                                       System.out.println("\nCannot assign expression result to Array");
                                                    }

                                                    else
                                                    {
                                                       if(RValueType.comapreTo("function") == 0)
                                                       {
                                                          //run function
                                                       }
                                                       ...
                                                       {
                                                          if(RValueType.compareTo("invalid") == 0)
                                                          {
                                                             errcode = 5;
                                                             error = true;
      ...
      public int countValues(String RValue)
      {
             return new StringTokenizer(RValue, ",").countTokens();
      }

      public int validateValueList(String RValue, String ArrayType, String ArraySize) throws Exception
      {
             ...
             boolean error = false;
             boolean done = false;
             boolean init_type = true;
             
             token = tokens.nextToken().trim(); //get rid of (
                   ...
                   else
                   {
                      if(token.compareTo("<") == 0)
                      {
                         if(init_type)
                         {
                            ...
                            else
                            {
                               if(token.compareTo(")") == 0)
                               {
                                  errcode = 5;
                                  error = true;
                                  System.out.println("\nIncorrectly formed list. Value expected");
                               }
                               ...
                               else
                               {
                                  ...
                                  else
                                  {
                                     ...
                                     {
                                        if(ArrayType.compareTo("dynamic") == 0 || new Integer(ArraySize).intValue() == 0)
                                        {
                                           errcode = 5;
                                           error = true;
                                           System.out.println("\nCannot add <value> to dynamic Array");
                                        }
                                        ...
                                        else
                                        {
                                           ...
                                           if(ValueType.compareTo("Identifier") == 0)
                                           {
                                              ...
                                              catch(IllegalArgumentException GetError)
                                              {
                                                    errcode = 5;
                                                    error = true;
                                                    System.out.println(GetError.getMessage());
                                              }
                                           }
                                        }
                                        ...
                                        if(!error)
                                        {
                                           if(ValueType.compareTo("function") == 0)
                                           {
                                              //run function and get type of result
                                           }

                                           if(ValueType.compareTo(ArrayType) != 0)
                                           {
                                              errcode = 5;
                                              error = true;
                                              System.out.println("\nCannot add " + ValueType + " to Array of type " + ArrayType);
                                           }
                                           ...
                                           if(!error)
                                           {
                                              ...
                                              if(token.compareTo(",") == 0)
                                              {
                                                 errcode = 5;
                                                 error = true;
                                                 System.out.println("\nList with <value> cannot accept multiple arguments");
                                              }

                                              else
                                              {
                                                 //this part of the if should never really run...
                                                 if(token.compareTo(")") != 0)
                                                 {
                                                    errcode = 5;
                                                    error = true;
                         ...
                         else
                         {
                            errcode = 5;
                            error = true;
                            System.out.println("\nList with discrete arguments cannot accept <value>");
                         }
                      }
                         ...
                         else
                         {
                            ...
                            else
                            {
                               ...
                               if(!error)
                               {
                                  if(ValueType.compareTo("function") == 0)
                                  {
                                     //run function and get value type
                                  }
                                  ...
                                  if(ValueType.compareTo(ArrayType) != 0)
                                  {
                                     errcode = 5;
                                     error = true;
                                     System.out.println("Cannot add " + ValueType + " to Array of type " + ArrayType);
                                  }
      ...
      public String[] copyArray(String ArraySize, String RValue)
      {
             

      }

      public String[] parseList(String RValue, String ArraySize) throws Exception
      {
             StringTokenizer tokens = new StringTokenizer(RValue, ",()<>", true);
             String[] ArrayVals = {};
             String LastToken = "";
             ...
             while(!done && tokens.hasMoreTokens() && i < new Integer(ArraySize).intValue())
             {
                   if(token.compareTo("<") == 0)
                   {
                      ...
                      if(ValueType.compareTo("expression") == 0)
                      {
                         ...
                         for(i = 0; i < new Integer(ArraySize).intValue(); i++)
                         {
                             ArrayVals[i] = Value.toString();
                         }
                      }
      ...
      public Variable getVariableObject(String varName) throws Exception
      {
             Variable thisVariable = new Variable();
	     int i = 0;
	     boolean done = false;

	     while(!done && i < variableCount)
	     {
	           if(variableList.elementAt(i) instanceof Array)
		   {
		      thisVariable = (Variable) variableList.elementAt(i);

		      if(thisVariable.getName().compareTo(varName) == 0)
		      {
		         done = true;
		      }
		   }
      ...
      public Array getArrayObject(String arrName) throws Exception
      {
	         ...
	         if(variableList.elementAt(i) instanceof Array)
		 {
		    ...
		    if(thisArray.getName().compareTo(arrName) == 0)
		    {
		       done = true;
		    }
		 }
      ...
      public boolean doesArrayExist(String arrName) throws Exception
      {
             Array thisArray = new Array();
	     int i = 0;
	     boolean done = false;
	     ...
	     while(!done && i < variableCount)
	     {
	           if(variableList.elementAt(i) instanceof Array)
		   {
		      thisArray = variableList.elementAt(i);
      ...
      public String getTypeOf(String varName) throws Exception
      {
             String varType = "";
             int i = 0;
             boolean found = false;
