...
class IO
{
      ...
      public int PrintCommand(StringTokenizer tokens) throws MyException
      {
             boolean error = false;
                         ...
                         else
                         {
                            ...
                            else
                            {
                               ...
                               if(DoCommand.length() > 0 && DoCommand.compareTo("+") != 0)
                               {
                                  ...
                                  {
                                     if(currentSymbolTable.typeOf(DoCommand).compareTo("int") == 0 ||
                                        currentSymbolTable.typeOf(DoCommand).compareTo("float") == 0 || 
                                        currentSymbolTable.typeOf(DoCommand).compareTo("double") == 0 || 
                                        currentSymbolTable.typeOf(DoCommand).compareTo("boolean") == 0)
                                     {
                                     ...
                                     {
                                        if(currentSymbolTable.typeOf(DoCommand).compareTo("char") == 0)
                                        {
                                        ...
                                        {
                                           if(currentSymbolTable.typeOf(DoCommand).compareTo("invalid") == 0)
                                           {
                                              errcode = 12;
                                              error = true;
                                              System.out.print("\n" + DoCommand + " ");
