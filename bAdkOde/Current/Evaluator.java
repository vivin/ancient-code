...
public class Evaluator implements Cloneable
{
    ...
    public int validateExpression(StringTokenizer tokens, String ResultType) throws MyException
    {
           boolean error = false;
           int errcode = 0;
           String Expr = "";
    ...
    private int organizeValueStack(StringTokenizer tokens, String ResultType) throws MyException
    {
    ...
    private String compute(String op1, String opr, String op2) throws MyException
    {
            String result = "";
            String VarType = "";
